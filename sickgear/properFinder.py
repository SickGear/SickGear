...
def search_propers(provider_proper_obj=None):
    ...
    age_shows, age_anime = sickgear.BACKLOG_LIMITED_PERIOD + 2, 14
...
def load_webdl_types():
    ...
    sickgear.WEBDL_TYPES = new_types + default_types
...
def get_needed_qualites(needed=None):
    # type: (sickgear.common.NeededQualities) -> sickgear.common.NeededQualities
    """
    ...
    if not sickgear.DOWNLOAD_PROPERS or needed.all_needed:
        return needed
