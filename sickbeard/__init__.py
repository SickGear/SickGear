...
def initialize(consoleLogging=True):
    with INIT_LOCK:
        ...
        global BRANCH, GIT_REMOTE, CUR_COMMIT_HASH, CUR_COMMIT_BRANCH, ACTUAL_LOG_DIR, LOG_DIR, WEB_PORT, WEB_LOG, ENCRYPTION_VERSION, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
            ...
            ANIME_SPLIT_HOME, SCENE_DEFAULT, BACKLOG_DAYS, ANIME_ASSUME_QUALITY
        ...
        ANIME_ASSUME_QUALITY = bool(check_setting_int(CFG, 'ANIME', 'anime_assume_quality', 0))
...
def save_config():
    ...
    new_config['ANIME']['anime_assume_quality'] = int(ANIME_ASSUME_QUALITY)
