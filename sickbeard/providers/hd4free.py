...
class HD4FreeProvider(generic.TorrentProvider):
        ...
        self.urls = {'config_provider_home_uri': self.url_base,
                     ...
                     'search': self.url_base + 'filter?%s' % '&'.join(
                         ['_token=%s', 'search=%s', 'categories[]=%s', 'freeleech=%s', 'doubleupload=%s', 'featured=%s',
                          'username=', 'imdb=', 'tvdb=', 'tmdb=', 'mal=',
                          'sorting=created_at', 'direction=desc', 'qty=50'])}
    ...
    def _authorised(self, **kwargs):
        ...
        return super(HD4FreeProvider, self)._authorised(
    ...
    def ui_string(key):
        ...
        return 'hd4free_digest' == key and 'use... \'laravel_session=yy\'' or ''
