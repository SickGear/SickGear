...
class BeautifulSoup(Tag):
    ...
    parse_only: Any = ...
    markup: Any = ...
    def __init__(self, markup: str = ..., features: Optional[Any] = ..., builder: Optional[Any] = ..., parse_only: Optional[Any] = ..., from_encoding: Optional[Any] = ..., exclude_encodings: Optional[Any] = ..., element_classes: Optional[Any] = ..., **kwargs: Any) -> None: ...
    def __copy__(self): ...
    def __getstate__(self): ...
    @staticmethod
    def _check_markup_is_url(markup: Any) -> None: ...
    def _feed(self) -> None: ...
    hidden: int = ...
    current_data: Any = ...
    currentTag: Any = ...
    ...
    _most_recent_element: Any = ...
    def object_was_parsed(self, o: Any, parent: Optional[Any] = ..., most_recent_element: Optional[Any] = ...) -> None: ...
    def _linkage_fixer(self, el: Any) -> None: ...
    def _popToTag(self, name: Any, nsprefix: Optional[Any] = ..., inclusivePop: bool = ...): ...
