...
from hachoir_py2.metadata.image import computeComprRate
from hachoir_py2.parser.image.exif import IFD, BasicIFDEntry
from hachoir_py2.parser.image.jpeg import (
    JpegFile, JpegChunk,
...
from hachoir_py2.core.tools import makeUnicode
