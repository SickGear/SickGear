...
from hachoir_py2.core.tools import (
    humanDuration, humanBitRate,
    humanFrequency, humanBitSize, humanFilesize,
    humanDatetime)
from hachoir_py2.core.language import Language
from hachoir_py2.metadata.filter import Filter, NumberFilter, DATETIME_FILTER
from datetime import date, datetime, timedelta
from hachoir_py2.metadata.formatter import (
    humanAudioChannel, humanFrameRate, humanComprRate, humanAltitude,
    humanPixelSize, humanDPI)
from hachoir_py2.metadata.setter import (
    setDatetime, setTrackNumber, setTrackTotal, setLanguage)
from hachoir_py2.metadata.metadata_item import Data
