...
from hachoir_py2.field import (FieldSet, ParserError, FieldError,
                               UInt8, UInt16, Enum, Field,
                               Bit, Bits, NullBits, NullBytes, PaddingBits,
                               String, RawBytes)
from hachoir_py2.parser.image.common import PaletteRGB
from hachoir_py2.core.endian import BIG_ENDIAN
from hachoir_py2.core.text_handler import textHandler, hexadecimal
from hachoir_py2.parser.image.exif import Exif
from hachoir_py2.parser.image.photoshop_metadata import PhotoshopMetadata
from hachoir_py2.parser.archive.zlib import build_tree
from hachoir_py2.core.tools import paddingSize, alignValue
            ...
            while True:
                ...
                for sos_comp, num_units in components:
                    for interleave_count in range(num_units):
                        yield JpegHuffmanImageUnit(self, "block[%i]component[%i][]" % (
