...
from hachoir_py2.field import (ParserError, FieldSet, MissingField,
                               Enum,
                               Bit, NullBits, Bits, UInt8, Int16, UInt16, UInt24, Int32, UInt32, Int64, UInt64,
                               TimestampMac32,
                               String, PascalString8, PascalString16, CString,
                               RawBytes, NullBytes)
from hachoir_py2.field.timestamp import timestampFactory
from hachoir_py2.core.endian import BIG_ENDIAN
from hachoir_py2.core.text_handler import textHandler

from hachoir_py2.core.tools import MAC_TIMESTAMP_T0, timedelta
...
class VideoMediaHeader(FieldSet):
    GRAPHICSMODE = {
        ...
        0x104: ('Straight alpha blend',
                "Blend of source and destination; "
                "blending factor is controlled by combining alpha channel and op color")
    }
...
class Load(FieldSet):
    def createFields(self):
        ...
        yield UInt32(self,
                     "hints")  # KeepInBuffer = 0x00000004; HighQuality = 0x00000100; SingleFieldVideo = 0x00100000
