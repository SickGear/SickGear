from hachoir_py3.parser import QueryParser
from hachoir_py3.regex import PatternMatching


# XXX hachoir_py3.regex uses str but the rest of hachoir_py3 uses bytes,
