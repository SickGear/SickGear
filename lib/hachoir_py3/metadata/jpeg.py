...
from hachoir_py3.metadata.image import computeComprRate
from hachoir_py3.parser.image.exif import IFD, BasicIFDEntry
from hachoir_py3.parser.image.jpeg import (
    JpegFile, JpegChunk,
