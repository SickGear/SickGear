...
from hachoir_py3.metadata.metadata import (Metadata, MultipleMetadata,
                                           registerExtractor)
from hachoir_py3.metadata.safe import fault_tolerant, getValue
from hachoir_py3.parser.container.riff import RiffFile
from hachoir_py3.parser.video.fourcc import UNCOMPRESSED_AUDIO
from hachoir_py3.core.tools import humanFilesize, makeUnicode, timedelta2seconds
from hachoir_py3.metadata.audio import computeComprRate as computeAudioComprRate
