...
from hachoir_py3.parser.image import (
    BmpFile, IcoFile, PcxFile, GifFile, PngFile, TiffFile,
    XcfFile, TargaFile, WMF_File, PsdFile)
from hachoir_py3.parser.image.png import getBitsPerPixel as pngBitsPerPixel
from hachoir_py3.parser.image.xcf import XcfProperty
