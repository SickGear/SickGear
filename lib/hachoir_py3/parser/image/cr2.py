...
from hachoir_py3.field import SeekableFieldSet, RootSeekableFieldSet, Bytes, String, UInt8, UInt16, UInt32
...
from hachoir_py3.parser.image.exif import IFD, IFD_TAGS
