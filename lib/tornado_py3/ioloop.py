...
from tornado_py3.util import Configurable, TimeoutError, import_object
...
class IOLoop(Configurable):
    ...
    def configure(
        ...
        if asyncio is not None:
            from tornado_py3.platform.asyncio import BaseAsyncIOLoop
    ...
    def configurable_default(cls) -> Type[Configurable]:
        from tornado_py3.platform.asyncio import AsyncIOLoop
