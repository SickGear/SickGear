...
from tornado_py3 import escape
from tornado_py3 import gen
from tornado_py3.httpserver import HTTPServer
from tornado_py3 import httputil
from tornado_py3 import iostream
import tornado_py3.locale
from tornado_py3 import locale
from tornado_py3.log import access_log, app_log, gen_log
from tornado_py3 import template
from tornado_py3.escape import utf8, _unicode
from tornado_py3.routing import (
    AnyMatches,
    DefaultHostMatches,
    HostMatches,
    ReversibleRouter,
...
from tornado_py3.util import ObjectDict, unicode_type, _websocket_mask
...
class RequestHandler(object):
    ...
    def clear(self) -> None:
        ...
        self._headers = httputil.HTTPHeaders(
            {
                "Server": "TornadoServer/%s" % tornado_py3.version,
    ...
    def get_browser_locale(self, default: str = "en_US") -> tornado_py3.locale.Locale:
    ...
    def __init__(
        ...
        **settings: Any
        ...
        if self.settings.get("autoreload"):
            from tornado_py3 import autoreload
