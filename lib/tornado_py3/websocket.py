...
from tornado_py3.escape import utf8, native_str, to_unicode
from tornado_py3 import gen, httpclient, httputil
from tornado_py3.ioloop import IOLoop, PeriodicCallback
from tornado_py3.iostream import StreamClosedError, IOStream
from tornado_py3.log import gen_log, app_log
from tornado_py3 import simple_httpclient
from tornado_py3.queues import Queue
from tornado_py3.tcpclient import TCPClient
from tornado_py3.util import _websocket_mask
...
class WebSocketHandler(tornado_py3.web.RequestHandler):
    ...
    def __init__(
        self,
        application: tornado_py3.web.Application,
    ...
    def write_message(
        ...
        if isinstance(message, dict):
            message = tornado_py3.escape.json_encode(message)
...
class _PerMessageDeflateCompressor(object):
    def __init__(
        ...
        if (
            ...
            self._compression_level = tornado_py3.web.GZipContentEncoding.GZIP_LEVEL
        else:
...
class WebSocketProtocol13(WebSocketProtocol):
    ...
    def write_message(
        ...
        if binary:
            ...
            opcode = 0x1
        message = tornado_py3.escape.utf8(message)
