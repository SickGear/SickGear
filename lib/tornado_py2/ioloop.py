...
from tornado_py2.concurrent import Future, is_future, chain_future, future_set_exc_info, future_add_done_callback  # noqa: E501
from tornado_py2.log import app_log, gen_log
from tornado_py2.platform.auto import set_close_exec, Waker
from tornado_py2 import stack_context
from tornado_py2.util import (
...
class IOLoop(Configurable):
    ...
    def configure(cls, impl, **kwargs):
        if asyncio is not None:
            from tornado_py2.platform.asyncio import BaseAsyncIOLoop
    ...
    def current(instance=True):
        ...
        if asyncio is None:
            ...
            try:
                ...
                if instance:
                    from tornado_py2.platform.asyncio import AsyncIOMainLoop
    ...
    def configurable_default(cls):
        if asyncio is not None:
            from tornado_py2.platform.asyncio import AsyncIOLoop
            return AsyncIOLoop
        return PollIOLoop
...
class PollIOLoop(IOLoop):
    ...
    def configurable_default(cls):
        if hasattr(select, "epoll"):
            from tornado_py2.platform.epoll import EPollIOLoop
            return EPollIOLoop
        if hasattr(select, "kqueue"):
            # Python 2.6+ on BSD or Mac
            from tornado_py2.platform.kqueue import KQueueIOLoop
            return KQueueIOLoop
        from tornado_py2.platform.select import SelectIOLoop
        return SelectIOLoop
