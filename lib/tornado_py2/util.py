...
def import_object(name):
    ...
    >>> import_object('tornado.escape') is tornado_py2.escape
    True
    >>> import_object('tornado.escape.utf8') is tornado_py2.escape.utf8
    True
    >>> import_object('tornado') is tornado_py2
    True
...
if (os.environ.get('TORNADO_NO_EXTENSION') or
    ...
    try:
        from tornado_py2.speedups import websocket_mask as _websocket_mask
    except ImportError:
