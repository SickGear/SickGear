...
from tornado_py2.log import access_log
from tornado_py2 import web
from tornado_py2.escape import native_str
from tornado_py2.util import unicode_type, PY3
...
class WSGIContainer(object):
    ...
    def __call__(self, request):
        ...
        if "server" not in header_set:
            headers.append(("Server", "TornadoServer/%s" % tornado_py2.version))
