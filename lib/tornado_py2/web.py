...
from tornado_py2 import escape
from tornado_py2 import gen
from tornado_py2 import httputil
from tornado_py2 import iostream
from tornado_py2 import locale
from tornado_py2.log import access_log, app_log, gen_log
from tornado_py2 import stack_context
from tornado_py2 import template
from tornado_py2.escape import utf8, _unicode
from tornado_py2.routing import (AnyMatches, DefaultHostMatches, HostMatches,
                                 ReversibleRouter, Rule, ReversibleRuleRouter,
                                 URLSpec)
from tornado_py2.util import (ObjectDict, raise_exc_info,
...
class Application(ReversibleRouter):
    ...
    def __init__(self, handlers=None, default_host=None, transforms=None,
        ...
        if self.settings.get('autoreload'):
            from tornado_py2 import autoreload
            autoreload.start()
