...
if 'APPENGINE_RUNTIME' in os.environ:
    from tornado_py2.platform.common import Waker

    def set_close_exec(fd):
        pass
elif os.name == 'nt':
    from tornado_py2.platform.common import Waker
    from tornado_py2.platform.windows import set_close_exec
else:
    from tornado_py2.platform.posix import set_close_exec, Waker
