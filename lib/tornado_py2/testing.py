...
try:
    ...
    from tornado_py2.httpclient import AsyncHTTPClient
    from tornado_py2.httpserver import HTTPServer
    from tornado_py2.simple_httpclient import SimpleAsyncHTTPClient
    from tornado_py2.ioloop import IOLoop, TimeoutError
    from tornado_py2 import netutil
    from tornado_py2.process import Subprocess
except ImportError:
...
from tornado_py2.log import app_log
from tornado_py2.stack_context import ExceptionStackContext
from tornado_py2.util import raise_exc_info, basestring_type, PY3
import functools
import inspect
import logging
import os
...
if asyncio is None:
    ...
    import tornado_py2.platform.asyncio
    _NON_OWNED_IOLOOPS = tornado_py2.platform.asyncio.AsyncIOMainLoop
...
def main(**kwargs):
    ...
    .. versionchanged:: 5.0
       ...
       log message).
    """
    from tornado_py2.options import define, options, parse_command_line
