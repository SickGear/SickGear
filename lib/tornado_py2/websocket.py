...
import sys
import struct
import tornado_py2.escape
import tornado_py2.web
import zlib

from tornado_py2.concurrent import Future, future_set_result_unless_cancelled
from tornado_py2.escape import utf8, native_str, to_unicode
from tornado_py2 import gen, httpclient, httputil
from tornado_py2.ioloop import IOLoop, PeriodicCallback
from tornado_py2.iostream import StreamClosedError
from tornado_py2.log import gen_log
from tornado_py2 import simple_httpclient
from tornado_py2.queues import Queue
from tornado_py2.tcpclient import TCPClient
from tornado_py2.util import _websocket_mask, PY3
...
class WebSocketHandler(tornado_py2.web.RequestHandler):
    ...
    def write_message(self, message, binary=False):
        ...
        if isinstance(message, dict):
            message = tornado_py2.escape.json_encode(message)
...
class _PerMessageDeflateCompressor(object):
    def __init__(self, persistent, max_wbits, compression_options=None):
        ...
        if compression_options is None or 'compression_level' not in compression_options:
            self._compression_level = tornado_py2.web.GZipContentEncoding.GZIP_LEVEL
        else:
...
class WebSocketProtocol13(WebSocketProtocol):
    ...
    def write_message(self, message, binary=False):
        ...
        if binary:
            ...
            opcode = 0x1
        message = tornado_py2.escape.utf8(message)
